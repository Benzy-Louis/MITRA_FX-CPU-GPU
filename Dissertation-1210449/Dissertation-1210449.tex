%% Version 1.04 @home 18:00 01.01.2015
%% Last version note - 
%% Added the omitted Chapter 5 on the GPU implementation
%% ----------------------------------------------------------------
%% Dissertation.tex -- MAIN FILE (the one that you compile with LaTeX)
%% ---------------------------------------------------------------- 
...
\input{Chapters/Chapter3} % Synthesis Imaging
\input{Chapters/Chapter4} % DiFX 
\input{Chapters/Chapter5} % DiFX GPU Implementation with help from xGPU code
